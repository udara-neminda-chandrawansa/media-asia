    ...
    <>
      ...
      <nav className=" h-[15dvh] flex flex-col w-full justify-center dm-sans">
        <div className="flex items-center justify-between w-full h-full">
          {/*logo trapezoid*/}
          <div
            className="z-10 flex items-center w-1/5 h-full bg-no-repeat bg-cover"
          ...
          <div className="flex flex-col items-center w-4/5 h-full">
            {/*email & location*/}
            <div className="flex w-full py-4 text-sm text-gray-600 bg-gray-100 justify-evenly h-1/6">
          ...
          {/*tel no trapezoid*/}
          <div
            className="flex items-center justify-center w-1/5 h-full gap-6 text-white bg-no-repeat bg-cover"
