        ...
        <div className="grid grid-cols-1 gap-12 max-lg:gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-justify text-gray-400">
              Together, we’re here to make  everyone’s day brighter. Our people,
              our audiences, our partners, our communities and our country. We
              touch hearts, change lives and drive deeper connections. And, as
              we create the best work of our careers, we’ll add a dash of Global
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <a href="mailto:talk@mediaasia.lk" className="text-gray-400 transition-colors hover:text-white">talk@mediaasia.lk</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
